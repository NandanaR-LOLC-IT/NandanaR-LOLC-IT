<h1 align="center">Hi , I'm Nandana Rathnayaka <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
...
- :school: I am a `Data Engineer` at [LOLC Technologies Ltd.](https://www.lolctech.com/) at [Colombo, Sri Lanka](https://maps.app.goo.gl/oprUt967ZtxZmE1bA).
- :trophy: `Microsoft Certified Fabric Analytic Engineer Associate`.
- :trophy: `Microsoft Certified Fabric Analytic EngineerAI Engineer Associate`.
- :technologist: I love using Software as a solution for every `Problem`.
- :computer: I am a competitive programmer at `Leetcode`, `Keggle`, `Google Contests`.
- :student: I’m currently learning `Msc in AI and Data science`.
